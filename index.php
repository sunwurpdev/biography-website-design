...
<head>
    ...
    <style>
        ...
        *{
            ...
            scrollbar-color: rgba(148,163,184,.55) rgba(15,23,42,.12);
        }
...
<body class="font-[Quicksand] select-none bg-slate-100 text-slate-800 transition-colors duration-300 dark:bg-slate-950 dark:text-slate-100">
    ...
    <header class="sticky top-0 z-50 border-b border-white/10 bg-white/70 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/75">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
            <div class="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl dark:text-white">
        ...
        <section class="grid items-center gap-10 lg:grid-cols-2">
            <div class="order-2 lg:order-1">
                ...
                <div class="mt-8 flex flex-col gap-4 sm:flex-row">
                    <button type="button" data-scroll="contact"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <button type="button" data-scroll="about"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10.293 15.707a1 1 0 010-1.414L13.586 11H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 111.414-1.414l5 5a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0z" clip-rule="evenodd" />
                        </svg>
                    </button>
                </div>
            ...
            <div class="order-1 lg:order-2">
                <div class="rounded-3xl border border-white/20 bg-white/70 p-5 shadow-2xl backdrop-blur-xl sm:p-6 dark:border-slate-800 dark:bg-slate-900/70">
                    <div class="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
                        <div class="h-24 w-24 overflow-hidden rounded-2xl shadow-lg ring-4 ring-white/30 dark:ring-slate-800">
                            <img
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                ...
                <div class="mt-8 grid gap-4 md:grid-cols-2">
                    <div class="flex items-center gap-4 rounded-2xl border border-white/40 bg-white/80 p-4 shadow-soft backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/80">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="truncate text-sm font-bold text-slate-800 sm:text-base dark:text-slate-100">johndoe@example.com</p>
                        </div>

                        <button type="button"
                            class="copy-btn flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-900/10 bg-slate-900 text-slate-100 shadow-darksoft transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:text-cyan-300 dark:border-white/10 dark:bg-slate-950 dark:text-slate-200"
                            data-copy="johndoe@example.com" data-label="Email" aria-label="Copy email">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                <path d="M6 9a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9Zm3-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1H9Z"/>
                            </svg>
                        </button>
                    </div>
                    ...
                    <div class="flex items-center gap-4 rounded-2xl border border-white/40 bg-white/80 p-4 shadow-soft backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/80">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="truncate text-sm font-bold text-slate-800 sm:text-base dark:text-slate-100">+44 7700 100200</p>
                        </div>

                        <button type="button"
                            class="copy-btn flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-900/10 bg-slate-900 text-slate-100 shadow-darksoft transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:text-cyan-300 dark:border-white/10 dark:bg-slate-950 dark:text-slate-200"
                            data-copy="+44 7700 100200" data-label="Phone number" aria-label="Copy phone number">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M8 7a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3h-1v-2h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-7a1 1 0 0 0-1 1v1H8V7Z"/>
                                <path d="M6 9a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9Zm3-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1H9Z"/>
                            </svg>
                    ...
                    <div class="flex items-center gap-4 rounded-2xl border border-white/40 bg-white/80 p-4 shadow-soft backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/80">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="truncate text-sm font-bold text-slate-800 sm:text-base dark:text-slate-100">Manchester, United Kingdom</p>
                        </div>

                        <button type="button"
                            class="copy-btn flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-900/10 bg-slate-900 text-slate-100 shadow-darksoft transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:text-cyan-300 dark:border-white/10 dark:bg-slate-950 dark:text-slate-200"
                            data-copy="Manchester, United Kingdom" data-label="Location" aria-label="Copy location">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M8 7a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3h-1v-2h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-7a1 1 0 0 0-1 1v1H8V7Z"/>
                                <path d="M6 9a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9Zm3-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1H9Z"/>
                            </svg>
                    ...
                    <div class="flex items-center gap-4 rounded-2xl border border-white/40 bg-white/80 p-4 shadow-soft backdrop-blur-md dark:border-slate-700 dark:bg-slate-900/80">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="truncate text-sm font-bold text-slate-800 sm:text-base dark:text-slate-100">www.johndoe.dev</p>
                        </div>

                        <button type="button"
                            class="copy-btn flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-slate-900/10 bg-slate-900 text-slate-100 shadow-darksoft transition-all duration-300 hover:-translate-y-0.5 hover:scale-105 hover:text-cyan-300 dark:border-white/10 dark:bg-slate-950 dark:text-slate-200"
                            data-copy="www.johndoe.dev" data-label="Website" aria-label="Copy website">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M8 7a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3h-1v-2h1a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1h-7a1 1 0 0 0-1 1v1H8V7Z"/>
                                <path d="M6 9a3 3 0 0 1 3-3h7a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H9a3 3 0 0 1-3-3V9Zm3-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1H9Z"/>
                            </svg>
    ...
    <footer class="border-t border-white/10 bg-white/60 px-4 py-8 text-center backdrop-blur-xl dark:border-slate-800 dark:bg-slate-950/70">
        <div class="mx-auto max-w-6xl">
            <p class="text-sm font-semibold text-slate-600 dark:text-slate-400">
                © <span id="year"></span> BioGraph | All Rights Reserved
            </p>
            <p class="mt-2 text-sm font-semibold text-slate-600 dark:text-slate-400">
                Developed by
                <a href="https://github.com/sunwurpdev" target="_blank" rel="noopener noreferrer"
                   class="bg-gradient-to-r from-cyan-400 via-sky-400 to-indigo-500 bg-clip-text font-bold text-transparent transition-opacity duration-300 hover:opacity-80">
                    sunwurpdev
                </a>
            </p>
        </div>
